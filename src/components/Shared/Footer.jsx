...
const Footer = () => {
  return (
    <div className="bg-[#333333] px-[30px] smpx-[40px] md:px-[70px] xl:px-[80px] pt-8">
      {/* logo */}
      <div className="p-[20px] w-[100px] aspect-square">
      ...
      <div className="w-full border-b-2 border-t-2 border-[#f5f5f5] border-opacity-5 py-8  text-white max-w-[1420px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 place-content-center gap-y-[32px] xl:gap-y-0 md:gap-x-[18px] xl:gap-x-[36px]">
        <div className="">
          <h1 className="md:text-[24px] xl:text-[20px] mb-[20px] font-bold">
            Services
          </h1>
          <h4 className="md:text-[20px] xl:text-[14px] mb-[10px] font-semibold">
          ...
          <h4 className="md:text-[20px] xl:text-[14px]  font-semibold">
        ...
        <div className="">
          ...
          <div className="text-[16px] xl:text-[14px] mb-[10px] font-semibold flex items-center space-x-[10px]">
            <FaLocationDot className="text-btnPrimary text-[18px]" />{" "}
            <h4>Piazza Napoleone, Lucca, Tuscany</h4>
          </div>
          <div className="text-[16px] xl:text-[14px] mb-[10px] font-semibold flex items-center space-x-[10px]">
            <BsFillTelephoneFill className="text-btnPrimary text-[18px]" />{" "}
            <h4> +39 346 368 5708</h4>
          </div>
          <div className="text-[16px] xl:text-[14px] mb-[10px] font-semibold flex items-center space-x-[10px]">
            <FaEnvelope className="text-btnPrimary text-[18px]" />{" "}
      ...
      {/* copyright section */}
      <div className="flex justify-between items-center space-x-1 text-[14px] py-8 text-white ">
        <span>Copyright © 2024. All rights reserved.</span>

        <span>
          Developed by{" "}
          <a
            href="https://devadil3251.netlify.app/"
            target="_blank"
            className="font-bold"
          >
            Dev Adil
