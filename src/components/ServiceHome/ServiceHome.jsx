import image1 from "../../assets/images/HomeService/girlPhone.png";
function ServiceHome() {
  return (
    <div className=" h-full w-full flex flex-col-reverse md:flex-row justify-between items-center  lg:space-x-[210px] md:px-[30px] xl:px-[150px] ">
